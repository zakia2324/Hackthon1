...
<div>
  ...
  <div className='flex pl-12 gap-[200px] flex-wrap text-xs sm:text-sm '>
    ...
    <div className=' ml-[585px] p-4 flex-wrap sm:640'>
    <button className='2px border solid bg-white text-black pb-[12px] pr-[54px] pl-[54px] pt-[16px] flex-wrap sm:640'>view all</button>
  </div>


 <h1 className='text-center text-[60px] font-extrabold flex-wrap'>Top Selling</h1>
  <div className='image flex gap-4 flex-wrap sm:640'>
  ...
  <div className='flex pl-12 gap-[200px] flex-wrap text-xs sm:text-sm'>
    ...
    <button className='2px border solid bg-white text-black pt-[16px] pr-[54px] pl-[54px] pb-[16px] m-2 hidden md:block'>view all</button>
    </div>

    
     
<div className='w-[1239px] h-[866px] bg-gray-200 top-[2417px] left-[100px] ml-[60px] flex-wrap sm:640 '>
  <h1 className='font-extrabold text-[30px] ml-[360px] flex-wrap sm:640 '>BROWSE BY DRESS STYLE</h1>
  
  <div className='grid grid-cols-2 h-[600px] w-[600px] justify-between gap-[180px] ml-[290px] flex-wrap sm:640 '>
  ...
  <div className='flex-wrap sm:640 sm:text-sm text-xs'>
    <h1 className='h-[58px] w-[654px] font-extrabold p-9'>OUR HAPPY CUSTOMERS</h1> </div>
    <div className='grid grid-cols-4 gap-[20px] p-9 ml-[170px] flex-wrap sm:640 text-xs sm:text-sm' >
